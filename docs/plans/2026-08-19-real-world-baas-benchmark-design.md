...
Node runs asynchronous closed-model virtual users. Each virtual user owns an authenticated session and waits for an action to finish before thinking and starting the next action.
