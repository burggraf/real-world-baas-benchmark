...
- `configs/full.json` uses the 626,000-record medium dataset, a 120-second warm-up, and at least five 300-second stages at 1/5/10/25/50 users. A current full run is approximately **35–60+ minutes per backend**, based on the measured medium seed plus configured warm-up/stages; adaptive capacity stages can make it longer.
