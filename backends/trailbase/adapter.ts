...
const session: AppSession = { dashboard: notImplemented, listTasks: notImplemented, getTask: notImplemented, createTask: notImplemented, updateTask: notImplemented, addComment: notImplemented, updateComment: notImplemented, updateMembershipRole: notImplemented, searchTasks: notImplemented, getProfile: notImplemented, updateProfile: notImplemented, refreshSession: notImplemented, signOut: notImplemented, close: notImplemented };
export const backend: Backend = {
  name: "trailbase", doctor: async (): Promise<BackendInfo> => notImplemented(), start: async () => notImplemented(), reset: async () => notImplemented(),
